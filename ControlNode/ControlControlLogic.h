...
#ifndef CONTROLCONTROLLOGIC_H_
#define CONTROLCONTROLLOGIC_H_

#include <omnetpp.h>
#include <map>
#include "ControlOutputHorizon.h"
...
class ControlControlLogic : public cSimpleModule{
   private:

     ControlOutputHorizon *gatesHorizon; //Puntero al horizonte de salida.
   ...
   public:
     ...
     virtual ~ControlControlLogic();

};

#endif /* CONTROLCONTROLLOGIC_H_ */
