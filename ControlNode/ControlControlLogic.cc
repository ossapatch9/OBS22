...
#include "ControlControlLogic.h"

Define_Module(ControlControlLogic);

ControlControlLogic::~ControlControlLogic() {
    free(recvBurstCounter);
    free(schedBurstCounter);
}

void ControlControlLogic::initialize() {
    ...
    gatesHorizon = check_and_cast<ControlOutputHorizon*>(
...
void ControlControlLogic::handleMessage(cMessage *msg) {
...
void ControlControlLogic::finish() {
